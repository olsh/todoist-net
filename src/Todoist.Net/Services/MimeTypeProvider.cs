...
// Adapted from Microsoft.AspNetCore.StaticFiles.FileExtensionContentTypeProvider
...
{
    /// <summary>
    /// Provides mapping from file extensions to MIME types.
    /// Based on Microsoft's FileExtensionContentTypeProvider from ASP.NET Core StaticFiles.
    /// </summary>
    internal static class MimeTypeProvider
    {
        // Notes:
        // - This table was initially copied from IIS and has many legacy entries maintained for backwards compatibility.
        ...
        private static readonly Dictionary<string, string> Mappings = new Dictionary<string, string>(System.StringComparer.OrdinalIgnoreCase)
        {
            { ".323", "text/h323" },
            { ".3g2", "video/3gpp2" },
            { ".3gp2", "video/3gpp2" },
        ...
        /// <summary>
        /// Attempts to get the MIME type for the specified file name based on its extension.
        /// </summary>
