...
namespace Todoist.Net.Services
{
    ...
    public interface ILabelsCommandService
    {
        ...
        /// <returns>
        /// The ID of the label, or a temporary ID when executed in a transaction.
        /// </returns>
        ...
        /// <exception cref="TodoistException">Command execution exception.</exception>
        [Obsolete(
            "Todoist has deprecated the label_update_orders command. Set Label.OrderKey and call UpdateAsync instead.")]
