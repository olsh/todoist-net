...
namespace Todoist.Net.Models
{
    ...
    /// </summary>
    public class UpdateKarmaGoals : ICommandArgument
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateKarmaGoals"/> class.
        /// </summary>
        public UpdateKarmaGoals()
        {
        ...
        public HashSet<DayOfWeek> IgnoreDays { get; set; }
