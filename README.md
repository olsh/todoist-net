...
The library is available as a [NuGet package](https://www.nuget.org/packages/Todoist.Net.APIv1/).

```powershell
# Package Manager
Install-Package Todoist.Net.APIv1

# .NET CLI
dotnet add package Todoist.Net.APIv1
```
...
> 💡 You can use the [**Todoist.Net.OAuth**](https://github.com/AhmedZaki99/todoist-net-oauth) NuGet package to easily integrate OAuth login with Todoist in your ASP.NET Core application.
